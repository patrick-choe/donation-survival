...
package com.github.patrick.donationsurvival.v1_15_R1.inventory
            ...
            when {
                slot < items.count() -> {
                    ...
                    if (itemStack.item != Items.AIR) {
                        return items.set(slot, ItemStack.a)?.run {
                ...
                slot < items.count() + armor.count() -> {
                    ...
                    if (itemStack.item != Items.AIR) {
                        return armor.set(slot - items.count(), ItemStack.a)?.run {
                            CraftItemStack.asBukkitCopy(this)
                        }
                    }
                }
                    ...
                    if (itemStack.item != Items.AIR) {
                        return extraSlots.set(slot - items.count() - armor.count(), ItemStack.a)?.run {
                            CraftItemStack.asBukkitCopy(this)
                        }
                    }
                }
